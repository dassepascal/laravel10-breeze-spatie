<x-app-layout>
    <div class="container mx-auto mt-5 overflow-x-scroll py-12">
            ...
            <div class="col-span-12">
                ...
                <div class="bg-white shadow-md rounded px-4 py-3">
                    <div class="flex justify-between items-center border-b mb-4 pb-2">
                        <h4 class="text-lg font-semibold">Edit Role</h4>
                    ...
                    <div class="p-4">
                        <form action="{{ url('roles/'.$role->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" value="{{ $role->name }}" id="name" class="mt-1 p-2 border rounded-md w-full" />
                            </div>
                            <div class="mb-4">
